for(var i =0; i<document.querySelectorAll(".drum").length; i++){
    document.querySelectorAll(".drum")[i].addEventListener("click", function() {
        ...
        var innerrHTML = this.innerHTML;
        makesound(innerrHTML);
        buttonannimation(innerrHTML);
        });
}
...
function buttonannimation(currentletter){
    var activebuttom = document.querySelector("."+currentletter);
